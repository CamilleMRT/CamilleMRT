        ...
        <div class="card m-3 text-center bg-light">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 text-center ml-5">
                    <form action="index.php?page=profil" id="update-pwd">
                ...
                <button id="updatepwd" name="udpatepwd" onclick="validate()" 
                class="btn btn-success m-3">Valider la modification</button>
            </form>
        </div>
    </div>
</div>
